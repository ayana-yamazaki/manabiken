  ...
  },
{
...

  {
    ...
    content: {
      layout: "basic",
      heading: "「正解がないまま手を動かす」感覚が、\n仕事の進め方になった",
      body: "美術大学での椅子制作では、スケッチを何百枚と描いて、\nその中から何案か選び、実寸プロトタイプを作り、座ってみる。\n「なんか違う」「ダメだった！」を何度も繰り返し前に進んでいく。\n最初から設計図を引くと、失敗が怖くなってしまう。\n\n小さく試すことは、レジリエンス高く生きるスキルだ。",
...

  {
    ...
    content: {
      layout: "bounce-viz",
      heading: "作るプロセスで、\nその人の特性がそのまま出てくる",
      body: "人にはそれぞれ凸凹がある。\n作りながら色々試す過程で、楽しくて得意で大好きな作業、苦手でどうにも手が止まる作業。\nそれを、教室で観察しあえる場が、美術だ。\n\nIQという言葉は「複数の知能」を平均化したものだ。\n他の教科は、満遍なく知能を底上げしようとする。\n平均の知能から外れた人間には辛い営みだ。",
    },
    observeAsActive: true,
  },

  {
    ...
    content: {
      layout: "mountain-viz",
      heading: "AIが個人の凹を埋めてくれる",
      body: "AIの本質は知能の拡張であり、民主化だ。\n苦手な領域はAIが補ってくれる。\nその後に残る「凸」\n──その子だけの力に最初に気づけるのは、美術の先生方であってほしい。",
    },
    observeAsActive: true,
  },
...

  {
    ...
    content: {
      layout: "text",
      heading: "この発表は、AIと作った",
      body: "Claude Code OpusとGemini、Cursorを使い、文章の構成からこのサイトの実装まで、AIと議論しながら、AIと作った。\n頭の中が雑然として論理的にまとめるのが苦手な私の凹を、\nAIが埋めてくれた。",
    },
  },
